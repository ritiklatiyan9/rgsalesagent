      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            {error && (
              <div className="p-3 text-sm text-red-500 bg-red-100 rounded-lg animate-element animate-delay-300">
                {error}
              </div>
            )}
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" disabled={loading} className="animate-element animate-delay-600 w-full rounded-2xl bg-primary py-4 font-medium text-primary-foreground hover:bg-primary/90 transition-colors">
